...
export default function Modal({ closeModal }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900 bg-opacity-90 p-2">
      <div className="bg-white rounded-[15px] shadow-xl max-w-[95%] sm:max-w-[80%] md:max-w-[70%] lg:max-w-[50%] xl:max-w-[40%] mx-auto p-[15px] sm:p-[20px] md:p-[25px] bg-opacity-90 relative h-auto sm:max-h-[80vh] md:max-h-[70vh] lg:max-h-[80vh] xl:max-h-[80vh]">
        ...
        <h2 className="font-semibold text-[32px] sm:text-[36px] md:text-[40px] mt-[30px] md:mt-[50px] lg:mt-[10px] xl:mt-[10px]">
          Contact Management
        </h2>
        <p className="font-light text-[16px] sm:text-[18px] md:text-[20px] leading-[24px] mt-[25px] md:mt-[40px] lg:mt-[10px] xl:mt-[10px]">
        ...
        <form onSubmit={handleSubmit} className="lg:overflow-y-auto xl:overflow-auto lg:h-[40vh] xl:h-[45vh] 2xl:h-auto">

          ...
          <div className="lg:col-span-5 md:col-span-5 sm:col-span-1 footerLogo my-2">
            ...
            <div>
              <p className="py-1 text-[9px] font-sans text-justify">
                All installment loans are underwritten by WLCC Lending JEM doing
                business as Clover Credit. Clover Credit is a Native American
                owned business operating within the interior boundaries of the
                Pine Ridge Reservation of the Oglala Sioux Tribe, a sovereign
                nation located in the United States.
              </p>

              <p className="py-1 text-[9px] font-sans text-justify">
                WLCC Lending JEM is an entity of the Wakpamni Lake Community
                Corporation (WLCC), a tribal corporation wholly owned by the
                Wakpamni Lake Community. The Wakpamni Lake Community is a local
                municipal subsidiary government under the Oglala Sioux Tribe.
                WLCC is incorporated under and governed by the laws of the
                Oglala Sioux Tribe, a federally recognized Indian Tribe, and the
                regulations of the Wakpamni Lake Community. WLCC operates
                independently of the Oglala Sioux Tribe. Correspondence should
                be directed to WLCC. As a tribal government, the Wakpamni Lake
                Community Corporation is a sovereign corporation and follows all
                applicable tribal and federal laws. State laws, regulations, and
                interest rates are not applicable to WLCC Lending JEM DBA Clover
                Credit or WLCC.
              </p>

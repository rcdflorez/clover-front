  ...
  return (
    <Layout>
        <section className="container mx-auto px-8 md:px-0">
            ...
            <h1 className="text-[40px] xl:text-[62px] 2xl:text-[76px] font-semibold">About Us</h1>
            <span className="greenParagraph block text-[#00D35B] text-[20px] md:text-[40px]  font-medium mt-[20px] md:mt-[40px]">Who We Are:</span>
            ...
            <div className="">
            <span className="greenParagraph block mt-[20px] md:mt-[40px] text-[#00D35B] text-[20px] md:text-[40px] font-medium">About Wakpamni Lake Community Corporation (WLCC) Services</span>
                ...
                <p className="commonParagraph text-[15px] md:text-[30px] font-light leading-[18px] md:leading-[36px] mt-[20px] md:mt-[40px]">View our Clover Credit Consumer Loan License here:</p>

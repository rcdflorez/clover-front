      ...
      <Layout>
        <section className="container mx-auto px-8 md:px-0">
          <div className="mt-[67px] xl:mt-[0px] 2xl:mt-[115px]">
            <h1 className="text-[40px] xl:text-[60px] 2xl:text-[80px] font-semibold">
              How it Works
            </h1>
            ...
            <p className="text-[15px] md:text-[30px] font-light leading-[18px] md:leading-[36px] mt-[20px] md:mt-[40px]">
              ...
              you a decision in just minutes.
            </p>
          </div>

          <div className="">
            <h1 className=" mt-[55px] md:mt-[115px] text-[40px] xl:text-[60px] 2xl:text-[80px] font-semibold">
              FAQs
            </h1>
          ...
          <div
            className={`${accordions.accordion} mt-[20px] md:mt-[40px]  text-[15px] md:text-[30px] font-light `}
          >
            <div>
              <Accordion
                className="accordion"
              ...
              />
              <Accordion
                title="How do I sign my loan agreement?"
              ...
              />
              <Accordion
                title="Are Clover Credit loans secure?"
              ...
              />
              <Accordion
                title="What kind of bank account is required to apply for a loan?"
              ...
              />
              <Accordion
                title="What is Clover Credit’s Privacy Policy?"
                content='You can view Clover Credit’s   <a target="_blank" href="/privacy_policy.pdf">
              Privacy Policy here.
            </a>'
              />
              <Accordion
                title="Will Clover Credit penalize me for paying off my loan early?"
              ...
              />
              <Accordion
                title="Is it cheaper to pay off my loan early?"
              ...
              />
              <Accordion
                title="Can I pay off my loan in one lump sum or do I have to make a series of extra payments?"
                content="You can make extra payments or pay it off in one lump sum. It’s totally up to you!"
              />
              <Accordion
                title="What are other benefits of paying off my loan early?"
              ...
              <div className="flex items-start md:items-start customFaqCard">
                ...
                <div>
                  <p className=" text-[15px] md:text-[30px] font-light leading-[18px] md:leading-[36px] mb-2 md:mb-16 ml-[15px] md:ml-[60px]">
                    ...
                    saying thank you for choosing Clover Credit and begin a part
                    of our loyal customer community.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start md:items-start customFaqCard">
                ...
                <div>
                  <p className=" text-[15px] md:text-[30px] font-light leading-[18px] md:leading-[36px] ml-[15px] md:ml-[60px]">
                    ...
                    extra steps - you reward will be seamless and automatically

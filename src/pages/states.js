    ...
    <Layout>
      <section className="container mx-auto px-8 md:px-0">
        <div className="mt-[67px] xl:mt-[0px] 2xl:mt-[115px]">
          ...
          <span className="greenParagraph mt-[35px] md:mt-[40px] block my-2 text-[#00D35B] text-[20px] md:text-[40px] font-medium leading-[24px] md:leading-[48px]">Clover Credit is currently available in the following states:</span>
          <p className="commonParagraph text-[15px] md:text-[30px] font-light pb-4 md:pb-8 leading-[18px] md:leading-[36px] mt-[20px] md:mt-[40px]">We are always looking at expanding so please check back often to see our most up-to-date list.</p>
        </div>
        ...
        <div className="">
          ...
          <span className="greenParagraph mt-[35px] md:mt-[40px] block my-2 text-[#00D35B] text-[20px] md:text-[40px] font-medium leading-[24px] md:leading-[48px]">We offer a range of short-term installment loans to fit your financial needs.</span>
          <div className='flex items-center justify-between my-[20px] md:my-[115px]'>
              <span className="text-center sm:w-auto sm:flex-1 stateIcon customFaqCard">
                ...
                <h6 className="mt-4 text-[15px] md:text-[45px] xl:text-[33.75px] 2xl:text-[45px] font-medium leading-[18px] md:leading-[54px]">Loans up to <br />$2000</h6>
              </span>
              ...
              <span className="text-center sm:w-auto sm:flex-1 customFaqCard">
                ...
                <h6 className="mt-4 text-[15px] md:text-[45px] xl:text-[33.75px] 2xl:text-[45px] font-medium leading-[18px] md:leading-[54px]">Competitive<br /> interest rates</h6>
              </span>
              
              <span className="text-center sm:w-auto sm:flex-1 customFaqCard">
                <FontAwesomeIcon icon={faWallet} className="mx-auto block md:inline  bg-green-200 p-4 text-green-500 rounded-md" />
                <h6 className="mt-4 text-[15px] md:text-[45px] xl:text-[33.75px] 2xl:text-[45px] font-medium leading-[18px] md:leading-[54px]">No hidden<br /> fees</h6>
              </span>
          </div>

          <p className="commonParagraph text-[15px] md:text-[30px] font-light leading-[18px] md:leading-[36px] mt-[20px] md:mt-[40px]">Simply pick the loan package that's right for you, use our super-simple online application process and get a decision in minutes.</p>
          <p className="commonParagraph text-[15px] md:text-[30px] font-light leading-[18px] md:leading-[36px] mt-[20px] md:mt-[40px]">* Returned payments, late payments, and non-payments may result in additional fees, charges, or collection activities pursuant to the terms of your loan agreement and as allowable under Tribal and applicable federal law.</p>
        </div>
        ...
        <div className="">
          ...
          <p className="commonParagraph text-[15px] md:text-[30px] font-light leading-[18px] md:leading-[36px] mt-[20px] md:mt-[40px]">A short-term installment loan is a great way to get extra cash when an unexpected event or emergency pops up, before you apply, consider these questions to make sure a short-term loan is right for you.</p>

          <span className="greenParagraph font-medium text-[20px] md:text-[40px] leading-[24px] md:leading-[48px] block my-2 text-[#00D35B] mt-[25px] md:mt-[115px]">Is borrowing money really necessary?	</span>
          <p className="commonParagraph font-light text-[15px] md:text-[30px] leading-[18px] md:leading-[36px] mt-[20px] md:mt-[40px]">Be realistic about your current financial standing. Weigh all of your options. If you are approved for a Clover Credit loan, you can have your money directly deposited into your bank account.</p>
          
          <span className="greenParagraph font-medium text-[20px] md:text-[40px] leading-[24px] md:leading-[48px] block mt-[25px] md:mt-[115px] text-[#00D35B]">Can I afford to pay back in full?</span>
          <p className="commonParagraph font-light text-[15px] md:text-[30px] leading-[18px] md:leading-[36px] mt-[20px] md:mt-[40px]">With Clover Credit, you can pay back your loan in weekly, bi-weekly, monthly, or semi-monthly installments. If you need to change your due date, just call us at <span className="text-[#00D35B] text-lg font-bold"> 833-276-2274</span> and we'll work with you to make it happen.</p>
          
          <span className="greenParagraph font-medium text-[20px] md:text-[40px] leading-[24px] md:leading-[48px] block mt-[25px] md:mt-[115px] text-[#00D35B]">Can I afford extra charges, interest, and fees if I miss a payment?</span>
          <p className="commonParagraph font-light text-[15px] md:text-[30px] leading-[18px] md:leading-[36px] mt-[20px] md:mt-[40px]">To avoid missing a payment, you can schedule automatic electronic payments from your checking account. You can set up this option in your Clover Credit account, or give us a call and we'll do it for you.</p>
          
          <span className="greenParagraph font-medium text-[20px] md:text-[40px] leading-[24px] md:leading-[48px] block mt-[25px] md:mt-[115px] text-[#00D35B]">Have some questions?</span>

  ...
  return <div>
    <Layout>
      <section className="container mx-auto px-8 md:px-0">
        ...
        <div className="">
          <h1 className="text-[40px] md:text-[80px] font-semibold leading-[43px] md:leading-[87px] mt-[55px] md:mt-[115px]">What to consider before applying for a Clover Credit loan?</h1>

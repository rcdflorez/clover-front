  ...
  return (
    <Layout>
      <div className="container mx-auto px-8 md:px-0">
        <h1 className="text-[40px] xl:text-[62px] 2xl:text-[65px] font-semibold mt-[67px] xl:mt-[0px] 2xl:mt-[50px]">
          Contact Us
        </h1>
        <div className="grid grid-cols-1 md:grid-cols-[7fr_5fr] gap-6 items-center">
          <div>
            <p className="commonParagraph text-[15px] md:text-[30px] md:leading-[36px] font-light mt-[20px] md:mt-[40px]">
              ...
              before applying, or you're just curious about what we offer, we're
              happy to help!
            </p>
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="mt-[20px] md:mt-[40px]">
                <input
                  ...
                  required
                />
                <p className="text-[15px] ml-3 text-gray-400 mt-1">

    ...
    <Layout>
      <div className="homebg md:mb-[190px]">
            ...
            <section className="loanApply col-span-6 lg:col-span-6 xl:col-span-6">
              <div className="container mx-auto pb-4 px-4">
                <div className="logoSec mb-1 md:hidden">
                  <StaticImage className="logo mb-4 mx-[30px] md:mx-auto" src="../images/logo.png" alt="Clover Credit" />
                </div>
        ...
        <section className="hidden md:block container mx-[15px] md:mx-auto my-5 p-2 md:mt-[180px] mb-[35px]">
          <h3 className="text-[40px] md:text-[96px] font-semibold md:mb-[55px] text-left leading-[43.6px] md:leading-[104.64px] mx-[30px] md:mx-auto">Building relationships through financial trust</h3>
          <p className="text-[15px] md:text-[30px] font-light pb-4 md:pb-8 leading-[18px] md:leading-[36px] mt-[20px] md:mt-[40px]">Clover Credit is a smart, simple, fast way to borrow money when you need it most. We offer short-term installment loans with no hidden fees. Our super easy online loan process offers you the funds you need now.</p>
        </section>
        <section className="mx-auto p-2">
          <article className="hidden md:block md:mx-auto">
            <h3 className="text-[40px] md:text-[96px] font-semibold md:mb-[55px] text-left leading-[43.6px] md:leading-[104.64px] mx-[30px] md:mx-auto">Do it yourself safely and securely</h3>
            <p className="text-[15px] md:text-[30px] font-light pb-4 md:pb-8 leading-[18px] md:leading-[36px] mt-[20px] md:mt-[40px]">Forget the paperwork. No need to talk to anyone.</p>
            <p className="text-[15px] md:text-[30px] font-light pb-2 leading-[18px] md:leading-[36px]">Use our fully automated, completely secure online portal to apply for a loan in minutes.</p>
          </article>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[15px] mt-[115px] items-start">
                <div className="col-span-1 lg:col-span-1">
                  <div className="main">
                    ...
                    <h3 className="font-narrow-bold text-[40px]">Common Questions</h3>
                    <p className="font-regular text-[20px] mb-[50px] md:mb-[20px]">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                    <Link to="/" className="font-normal text-[20px]">Learn More</Link>
                  </div>
                  <h3 className="text-[32px] md:text-[40px] font-bold mb-[25px] text-left">
                    Apply now for a loan up to
                    <span className="text-[#00D35B]"> $2000</span>
                  </h3>
                  <RangeInput min={300} max={2000} step={50} />
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[15px] mt-[115px] items-start">
                <div className="col-span-1 md:col-span-1 lg:col-span-1">
                  <div className="main">
                    ...
                    <p className="font-medium  text-[20px] mb-[50px] md:mb-[20px]">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
            ...
            <div className={`${cardStyles.card} font-Aldrich `}>
              <div className="pt-4 gap-2">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <div className="col-span-1 lg:col-span-1">
                    <div className="main">
                      ...
                      <p>
                        At Clover Credit, transparency is one of our core
                        values, so we've compiled answers to our most frequently
                  ...
                  <div className="col-span-1 md:col-span-2 lg:col-span-3">
                    <span>
                      <strong>How to benefit:</strong> We’ve made it even easier
                      for you to enjoy the benefits of our loyalty program. Once
                      you accumulate 1500 loyalty points, our system will
                      automatically apply a $25 discount to your next payment.
                      No need to worry about redemption or extra steps - your
                      reward will be seamlessly and automatically applied,
                      making your next payment even more affordable.
                    </span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <div className="col-span-1 md:col-span-2 lg:col-span-3">
                    <span>
                      <strong>Earn Loyalty Points:</strong> Every dollar you pay
                      towards your loan with Clover Credit earns you 1 loyalty
                      point. As you make regular payments, your points will
                      start to accumulate, bringing you closer to exciting
                      rewards. <br />
                      <br />
                      <br />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div className="col-span-1 md:col-span-2 lg:col-span-3">
                    <span>
                      <strong>Seamless Redemption:</strong> We’ve made it even
                      easier for you to enjoy the benefits of our loyalty
                      program. Once you accumulate 1500 loyalty points, our
                      system will automatically apply a $25 discount to your
                      next payment. No need to worry about redemption or extra
                      steps - your reward will be seamlessly and automatically
